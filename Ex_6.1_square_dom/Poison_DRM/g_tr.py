...
derivative_y_x1 = diff(y,x1)
derivative_y_x2 = diff(y,x2)
...
ldderivative_y_x1 = lambdify(variables,derivative_y_x1,'numpy')
ldderivative_y_x2 = lambdify(variables,derivative_y_x2,'numpy')
...
def data_gen_interior(collocations):
    ...
    deri_y_x1 = [ldderivative_y_x1(d[0],d[1]) for d in collocations]
    deri_y_x2 = [ldderivative_y_x2(d[0],d[1]) for d in collocations]

    return from_seq_to_array([y_gt,f,deri_y_x1,deri_y_x2])
